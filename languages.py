...
# यह डिक्शनरी विथड्रॉल की मंजूरी या अस्वीकृति के बाद यूज़र को भेजे गए संदेशों को रखती है।
WITHDRAWAL_STATUS_UPDATE_MESSAGES = {
    ...
    "hi": {
        "approved": "🎉 अच्छी खबर! आपकी **{points:.2f} पॉइंट्स** ({rupees:.2f} रुपये) की विथड्रॉल रिक्वेस्ट **मंज़ूर** हो गई है और प्रोसेस कर दी गई है। आपके पैसे जल्द ही आपके खाते में पहुंच जाएंगे।\n\nहमारे बॉट का उपयोग करने के लिए धन्यवाद!",
        "rejected": "😞 आपकी **{points:.2f} पॉइंट्स** ({rupees:.2f} रुपये) की विथड्रॉल रिक्वेस्ट **ख़ारिज** कर दी गई है। यह गलत विवरण या अन्य कारणों से हो सकता है। यदि आपके कोई प्रश्न हैं तो कृपया सहायता से संपर्क करें।",
...
# यह फ़ंक्शन यूज़र की भाषा के अनुसार सही अनुवादित टेक्स्ट लौटाता है।
# अगर किसी भाषा में कोई टेक्स्ट मौजूद नहीं है, तो यह डिफ़ॉल्ट भाषा (अंग्रेज़ी) का उपयोग करेगा।
def get_text(user_id, key, **kwargs):
    # यहां `get_user_language` फ़ंक्शन का उपयोग किया गया है।
    # यह फ़ंक्शन `database_utils.py` में होगा और MongoDB से यूज़र की भाषा फ़ेच करेगा।
    # इसलिए, हमें इसे यहां इंपोर्ट करना होगा या मान लेना होगा कि यह ग्लोबल रूप से उपलब्ध है।
    # मैं अभी के लिए मान रहा हूं कि यह कहीं और से उपलब्ध कराया जाएगा, या आपको इसे बाद में जोड़ना होगा।
    # एक अस्थायी समाधान के रूप में, आप इसे सीधे languages.py में भी जोड़ सकते हैं,
    # लेकिन यह MongoDB एक्सेस करेगा, जो आमतौर पर यूटिलिटी फ़ाइलों में होता है।
    # अभी, हम इसे एक डमी के रूप में या इस फ़ाइल के दायरे में मानेंगे।
    
    # **महत्वपूर्ण: get_user_language को डेटाबेस_यूटिल्स.py से इंपोर्ट करना होगा**
    from .database_utils import get_user_language # यह आपको बाद में जोड़ना होगा जब database_utils.py बन जाए
